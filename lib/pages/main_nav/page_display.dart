                      ...
                      builder: (BuildContext context,
                        ...
                        if (snapshot.hasData) {
                          ...
                          children = <Widget>[
                            ...
                            Text(
                              'Phase ${snapshot.data[0]}: ',
                              style: TextStyle(fontSize: 22),
                            ),
                            Text(
                              'Week ${snapshot.data[1]}',
                              style: TextStyle(fontSize: 22),
                            ),
                          ];
                        } else {
                  ...
                  child: DrawerHeader(
                    child: Column(
                      children: <Widget>[
                        Align(
                          child: IconButton(
                              icon: Icon(Entypo.cross, color: featureColor),
                              alignment: Alignment.centerLeft,
                              onPressed: () => Navigator.pop(context)),
                          alignment: Alignment.centerLeft,
                        ),
                        Expanded(
                          child: Icon(Icons.person_pin_rounded, size: 100),
                        ),
                        Expanded(
                ...
                ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return Padding(
                      ...
                      child: ListTile(
                        tileColor:
                            _page == index ? background : drawerBackground,
                        leading: Icon(
                          item['icon'],
                          color: _page == index ? featureColor : drawerText,
                        ),
                        title: Text(
                          item['name'],
                          style: TextStyle(
                        ...
                        trailing: _page == index
                            ? Icon(Icons.arrow_back_ios_outlined,
                                color:
                                    _page == index ? featureColor : drawerText)
