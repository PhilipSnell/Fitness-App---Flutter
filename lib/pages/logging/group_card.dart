...
import 'package:xcell/pages/logging/group_items.dart';
...
class groupCard extends StatefulWidget {
  ...
  final completion;
  final int index;
  const groupCard({Key key, this.item, this.completion, this.day, this.index})
      : super(key: key);
              ...
              children: [
                ...
                Expanded(
                  child: CircularPercentIndicator(
                    ...
                    percent: _completion,
                    progressColor:
                        _completion == 1 ? completedLogging : featureColor,
                    center: ClipRRect(
